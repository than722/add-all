...
interface ProgramsGridProps {
  programs: Program[]; // Changed from normalizedAdminPrograms to programs
  archivedPrograms: string[];
  setArchivePrompt: (prompt: ArchivePrompt) => void;
  dummyDetails: any; // Consider making this more specific if possible
}

export default function ProgramsGrid({ programs, archivedPrograms, setArchivePrompt, dummyDetails }: ProgramsGridProps) { // Updated destructuring
  ...
  const filteredPrograms = programs // Used 'programs' instead of 'normalizedAdminPrograms'
