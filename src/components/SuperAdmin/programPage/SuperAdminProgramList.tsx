...
const SuperAdminProgramListClient: React.FC = () => {
  ...
  const [adminPrograms, setAdminPrograms] = useState<Program[]>(() => {
    ...
    console.log('SuperAdminProgramListClient: Initializing adminPrograms from programsData.ts');
  ...
  console.log('SuperAdminProgramListClient Rendered. Current adminPrograms state length:', adminPrograms.length);
  console.log('SuperAdminProgramListClient Rendered. Current filteredPrograms length:', filteredPrograms.length);
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-2">
                      <Link
                        href={`/superadmin/programlist/${encodeURIComponent(p.program)}/view-outline`} // Link to superadmin-specific view outline
                      ...
                      <Link
                        href={`/superadmin/programlist/${encodeURIComponent(p.program)}/edit-outline`} // Link to superadmin-specific edit outline
