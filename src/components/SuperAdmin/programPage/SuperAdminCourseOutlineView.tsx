...
export default function SuperAdminCourseOutlineViewClient({ programName }: SuperAdminCourseOutlineViewClientProps) {
  ...
  // The Super Admin context implies the current user is a super admin.
      ...
      <div className="min-h-screen flex flex-col md:flex-row bg-gray-50 font-sans">
        ...
        <aside className="w-full md:w-1/3 bg-white shadow-lg p-4 sm:p-6 sticky top-0 overflow-y-auto max-h-[60vh] md:max-h-screen z-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center mb-3 sm:mb-4 gap-2">
            {/* Back button logic updated to go back to the Super Admin program list */}
            <button
              ...
              onClick={() => router.push('/superadmin/programlist')} // Go back to Super Admin Programs List
            >
