...
interface SuperAdminEditCourseOutlineClientProps { // Renamed interface
  programName: string; // The program name passed from the server page
}

export default function SuperAdminEditCourseOutlineClient({ programName }: SuperAdminEditCourseOutlineClientProps) { // Renamed component
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        <Sidebar
          ...
          editModuleTitle={editModuleTitle}       // Pass this prop
          setEditModuleTitle={setEditModuleTitle} // Pass this prop
          ...
          onBackClick={() => router.push(`/superadmin/programlist`)} 
          backButtonText={`← Back to programs list`} 
        />
