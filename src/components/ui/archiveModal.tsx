  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-2 sm:px-0">
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-xs sm:max-w-sm">
        <h3 className="text-base sm:text-lg font-bold mb-2 sm:mb-4 text-[#002B5C]">Archive {typeLabel}</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-end">
          <button
            className="px-4 py-2 rounded bg-gray-200 text-[#002B5C] font-semibold hover:bg-gray-300 text-sm sm:text-base"
            onClick={onCancel}
          >
            Cancel
          </button>
