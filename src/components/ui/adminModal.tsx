  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-2 sm:px-0">
      <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-2xl w-full max-w-md min-w-[320px] flex flex-col items-center relative animate-fade-in">
        <h3 className="text-base sm:text-lg font-bold mb-4 text-[#002B5C] text-center">
          {isAdmin
        ...
        <div className="flex flex-row justify-center gap-4 mt-4 w-full">
          <button
            className="bg-[#002B5C] text-white px-6 py-2 rounded-full font-semibold hover:bg-[#001f40] text-base w-24"
            onClick={onConfirm}
          >
            Yes
          </button>
          <button
            className="bg-gray-300 text-[#002B5C] px-6 py-2 rounded-full font-semibold hover:bg-gray-400 text-base w-24"
            onClick={onCancel}
          >
            No
          </button>
