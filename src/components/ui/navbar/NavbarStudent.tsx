      ...
      <nav className="relative w-full shadow-md" style={{ backgroundColor: '#08228d' }}>
        ...
        <div className="hidden sm:flex items-center justify-between w-full px-6 py-4 relative">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-10">
            ...
            <button onClick={() => router.push('/studentview?tab=all')} className="text-white font-extrabold hover:text-[#FFC72C] text-base py-1 px-2">All Programs</button>
            <button onClick={() => router.push('/studentview?tab=mine')} className="text-white font-extrabold hover:text-[#FFC72C] text-base py-1 px-2">My Programs</button>
          </div>
          {/* Right: Profile Icon */}
        ...
        <div className="flex sm:hidden flex-col w-full px-3 py-3">
          ...
          {navOpen && (
            <div className="flex flex-col w-full mt-2 gap-2 bg-[#08228d] rounded shadow-md z-20">
              ...
              <button onClick={() => { setNavOpen(false); router.push('/studentview?tab=all'); }} className="text-white font-extrabold hover:text-[#FFC72C] text-base py-1 px-2 text-left">All Programs</button>
              <button onClick={() => { setNavOpen(false); router.push('/studentview?tab=mine'); }} className="text-white font-extrabold hover:text-[#FFC72C] text-base py-1 px-2 text-left">My Programs</button>
            </div>
          )}
        </div>
      </nav>
