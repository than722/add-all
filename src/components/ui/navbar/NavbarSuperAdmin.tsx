    ...
    <>
      <nav className="relative w-full shadow-md" style={{ backgroundColor: '#08228d' }}>
        ...
        <div className="hidden sm:flex items-center justify-between w-full px-10 py-4 relative">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-8 text-white font-extrabold text-base">
          ...
          {/* Right: Profile Icon */}
          <div className="flex items-center min-w-max ml-auto">
            <button
        ...
        <div className="flex sm:hidden flex-col w-full px-3 py-3">
          ...
          {navOpen && (
            <div className="flex flex-col w-full mt-2 gap-2 bg-[#08228d] rounded shadow-md z-20 text-white font-extrabold text-base">
              ...
              <a href="#programs" className="hover:text-[#FFC72C]" onClick={() => setNavOpen(false)}>Programs</a>
              <a href="#administrators" className="hover:text-[#FFC72C]" onClick={() => setNavOpen(false)}>Administrators</a>
            </div>
          )}
        </div>
      </nav>
